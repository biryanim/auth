...
//go:generate minimock -i github.com/biryanim/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, userInfo *model.UserCreate) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, userInfo *model.UserCreate)
	...
	funcGet          func(ctx context.Context, filter *filter.Filter) (up1 *model.User, err error)
	funcGetOrigin    string
	inspectFuncGet   func(ctx context.Context, filter *filter.Filter)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mUserRepositoryMockGet

	funcUpdate          func(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, userInfo *model.UserCreate) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserRepositoryMockCreateParams{ctx, userInfo}
...
func (mmCreate *mUserRepositoryMockCreate) ExpectUserInfoParam2(userInfo *model.UserCreate) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.expectationOrigins.originUserInfo = minimock.CallerInfo(1)

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.Create
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, userInfo *model.UserCreate)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, userInfo *model.UserCreate) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, userInfo *model.UserCreate) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserRepositoryMockCreateParams{ctx, userInfo},
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, userInfo *model.UserCreate) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateParams{ctx, userInfo}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateParams{ctx, userInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userInfo != nil && !minimock.Equal(*mm_want_ptrs.userInfo, mm_got.userInfo) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter userInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreate.CreateMock.defaultExpectation.expectationOrigins.originUserInfo, *mm_want_ptrs.userInfo, mm_got.userInfo, minimock.Diff(*mm_want_ptrs.userInfo, mm_got.userInfo))
			}
	...
	mmCreate.t.Fatalf("Unexpected call to UserRepositoryMock.Create. %v %v", ctx, userInfo)
	return
}
...
func (mmGet *mUserRepositoryMockGet) Expect(ctx context.Context, filter *filter.Filter) *mUserRepositoryMockGet {
...
func (mmGet *mUserRepositoryMockGet) ExpectFilterParam2(filter *filter.Filter) *mUserRepositoryMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserRepositoryMockGet) Inspect(f func(ctx context.Context, filter *filter.Filter)) *mUserRepositoryMockGet {
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, filter *filter.Filter) (up1 *model.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserRepositoryMockGet) When(ctx context.Context, filter *filter.Filter) *UserRepositoryMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *UserRepositoryMock) Get(ctx context.Context, filter *filter.Filter) (up1 *model.User, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, id, updateInfo}
...
// ExpectUpdateInfoParam3 sets up expected param updateInfo for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectUpdateInfoParam3(updateInfo *model.UpdateUserInfo) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.paramPtrs.updateInfo = &updateInfo
	mmUpdate.defaultExpectation.expectationOrigins.originUpdateInfo = minimock.CallerInfo(1)

	return mmUpdate
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserRepositoryMockUpdateParams{ctx, id, updateInfo},
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) (err error) {
	...
	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, id, updateInfo)
	}

	mm_params := UserRepositoryMockUpdateParams{ctx, id, updateInfo}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, id, updateInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.updateInfo != nil && !minimock.Equal(*mm_want_ptrs.updateInfo, mm_got.updateInfo) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter updateInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmUpdate.UpdateMock.defaultExpectation.expectationOrigins.originUpdateInfo, *mm_want_ptrs.updateInfo, mm_got.updateInfo, minimock.Diff(*mm_want_ptrs.updateInfo, mm_got.updateInfo))
			}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, id, updateInfo)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v %v", ctx, id, updateInfo)
	return
}
