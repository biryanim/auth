...
//go:generate minimock -i github.com/biryanim/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, userInfo *model.UserCreate) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, userInfo}
...
// ExpectUserInfoParam2 sets up expected param userInfo for UserService.Create
func (mmCreate *mUserServiceMockCreate) ExpectUserInfoParam2(userInfo *model.UserCreate) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, userInfo *model.UserCreate)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, userInfo *model.UserCreate) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, userInfo *model.UserCreate) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserServiceMockCreateParams{ctx, userInfo},
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, userInfo *model.UserCreate) (i1 int64, err error) {
	...
	mm_params := UserServiceMockCreateParams{ctx, userInfo}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, userInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userInfo != nil && !minimock.Equal(*mm_want_ptrs.userInfo, mm_got.userInfo) {
				mmCreate.t.Errorf("UserServiceMock.Create got unexpected parameter userInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v", ctx, userInfo)
	return
}
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, id, updateInfo}
...
// ExpectUpdateInfoParam3 sets up expected param updateInfo for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectUpdateInfoParam3(updateInfo *model.UpdateUserInfo) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserServiceMockUpdateParams{ctx, id, updateInfo},
...
// Update implements mm_service.UserService
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, updateInfo *model.UpdateUserInfo) (err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, id, updateInfo}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, id, updateInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.id != nil && !minimock.Equal(*mm_want_ptrs.id, mm_got.id) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter id, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.updateInfo != nil && !minimock.Equal(*mm_want_ptrs.updateInfo, mm_got.updateInfo) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter updateInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v %v", ctx, id, updateInfo)
	return
}
